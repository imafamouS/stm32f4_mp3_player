...
{ 
  /* Initialize LEDS */
  STM_EVAL_LEDInit(LED3);	//Yellow(Orange) MCU side 
  STM_EVAL_LEDInit(LED4);	//Green          USER button
  STM_EVAL_LEDInit(LED5);	//Red            Reset Button
  STM_EVAL_LEDInit(LED6);	//Blue           mini USB
